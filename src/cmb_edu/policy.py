...
INVARIANT_TRANSLATIONS: dict[str, str] = {
    "PATTERN_NOT_PROOF": "MACHINE_PATTERN_IS_NOT_CERTAINTY",
...
def privacy_from_tokens(tokens: list[str] | tuple[str, ...] | None) -> PrivacyPolicy:
    """Build a deny-by-default privacy policy from kid-friendly declarations."""

    persistence = "ephemeral"
    if not tokens:
        return PrivacyPolicy(persistence=persistence)
