...
- Canon integration layer: human-readable `CANON.md`, strict `cmb.canon.v1` machine graph, executable `cmb-provenance canon` navigation, linked/unlinked relationship semantics, schema validation, and tests that prevent dangling edges or false artifact-presence claims.
