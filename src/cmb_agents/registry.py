  ...
  "agent_card": {
    ...
    "skills": [
      ...
      },
      {
        ...
        "description": "Run deterministic value-permutation null-model tests for observed GEMATRIA-GLITCH-1 findings while preserving EMPIRICAL_P_VALUE != TRUTH_PROBABILITY."
      }
    ],
    "interfaces": [
      {
