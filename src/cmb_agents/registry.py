  ...
  "agent_card": {
    ...
    "skills": [
      ...
      },
      {
        ...
        "description": "Compile CMB-SDL human authority declarations into deterministic CMB Authority IR."
      },
      {
      ...
      {
        "id": "compare-gematria-corpora",
        "description": "Compare canonical GEMATRIA-GLITCH-1 anomaly signatures across provenance-grade corpora and report instance replication and type recurrence while preserving REPLICATION != PROOF."
      },
      {
        "id": "test-gematria-null-model",
        "description": "Run deterministic value-permutation null-model tests with Benjamini-Hochberg FDR-adjusted q-values and duplicate-token safety while preserving EMPIRICAL_P_VALUE != TRUTH_PROBABILITY."
      },
      {
        "id": "test-gematria-null-ensemble",
        "description": "Compare GEMATRIA-GLITCH-1 findings across unrestricted and word-length-stratified permutation baselines and report cross-model robustness while preserving ROBUST_ACROSS_MODELS != TRUTH."
      },
      {
        "id": "validate-gematria-out-of-sample",
        "description": "Lock GEMATRIA-GLITCH-1 discovery candidates, test them against a distinct validation corpus, and separate exact instance replication from independent anomaly-class recurrence."
      }
    ],
    "interfaces": [
      {
      ...
      },
      {
        "type": "mcp_stdio",
        "command": "cmb-mcp",
        "protocol_generation": "2026-07-28",
        "sdk": "mcp-python-2.x"
      },
      {
        "type": "authority_cli",
        "command": "cmb-sdl compile",
        "protocol": "CMB-SDL-1"
      },
      {
        "type": "capability_cli",
        "command": "cmb-cap verify",
        "protocol": "CMB-CAP-1"
      }
    ],
    "standards_status": {
      "mcp": "official_sdk_reference_adapter_not_independently_certified",
      "a2a": "not_conformant_no_public_a2a_server",
      "w3c_vc": "vc_2_0_projection_only_not_data_integrity_conformant",
      "cmb_cap_a2a": "experimental_extension_not_official_a2a_extension"
    }
  },
  "recommendations": [
    {
